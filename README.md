...
13. Страница "Контакты" - сделать статичную верстку
14. Развернуть на виртуалке itldc.com (удалить apache)
15. Поправить Desktop верстку, изменить главную страницу, отключить слайдер, добавить горизонтальную картинку
16. Заменить почтовый сервер на NodeMailer
